...
public class Miner extends BaseGameEntity {
	public static final int ComfortLevel = 7;
	public static final int MaxNuggets = 7;
	public static final int ThirstLevel = 7;
	public static final int TirednessThreshold = 7;
	...
	public void exhaust(){iFatigue = TirednessThreshold;}
